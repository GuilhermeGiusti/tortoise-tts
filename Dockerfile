...
# RUN conda create -n tortoise python=3.8 numba inflect -y && \
#     source activate tortoise && \
#     conda install --yes pytorch==2.2.2 torchvision==0.17.2 torchaudio==2.2.2 pytorch-cuda=12.4 -c pytorch -c nvidia && \
